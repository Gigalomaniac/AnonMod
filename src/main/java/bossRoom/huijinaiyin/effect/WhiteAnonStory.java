...
public class WhiteAnonStory extends AbstractGameEffect {
    ...
    public WhiteAnonStory(int code) {
        ...
        switch (code) {
            case 2:
                this.img = new Texture(Gdx.files.internal("img/vfx/White.png"));
                break;
            case 3:
            case 5:
            case 8:
    ...
    public void render(SpriteBatch sb) {
        ...
        if(this.duration < 10.0F)
        FontHelper.renderSmartText(sb, FontHelper.largeDialogOptionFont, this.word, this.x, this.y, (float)Settings.WIDTH, 0.5F, this.color2);
    }
