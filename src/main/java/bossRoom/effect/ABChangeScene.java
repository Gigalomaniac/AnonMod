...
public class ABChangeScene extends AbstractChangeSceneEffect{
  ...
  public ABChangeScene(Texture img) {
        this.color = Color.WHITE.cpy();
        this.renderBehind = true;
        this.img = img;
        this.img2 = ImageMaster.loadImage("img/vfx/Mask.png");
...
//                    }
    ...
    public void render(SpriteBatch sb) {
        ...
        if (this.x == 0.0F) {
            sb.draw(this.img, 0.0F, 0.0F, Settings.WIDTH, newHeight);
        } else {
//            drawAlphaMask(sb);
