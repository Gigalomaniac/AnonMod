...
public class ChangeRainScene extends AbstractChangeSceneEffect{
  ...
  public ChangeRainScene(Texture img) {
    ...
    public void render(SpriteBatch sb) {
            { if(rain){
                RainPatch.ApplyRainShaderToAllCombatBGs.initShader(AbstractDungeon.scene);
                sb.setShader(RainPatch.ApplyRainShaderToAllCombatBGs.getSceneShader(AbstractDungeon.scene));
                RainPatch.ApplyRainShaderToAllCombatBGs.getSceneShader(AbstractDungeon.scene).setUniformf("u_time",RainPatch.ApplyRainShaderToAllCombatBGs.getTime());
            }}
