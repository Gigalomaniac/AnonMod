...
public class FallingStar extends AbstractChangeSceneEffect{
...
//        -this.img.getHeight()*2
        ...
        public void update() {
            ...
            float place = this.timer % 8;
            int fallingNum = (int) (this.timer / 8);
...
//                    System.out.println("yyyyyyy"+changedY);
            ...
            targetX =changedX + Settings.WIDTH -(( Settings.WIDTH + this.img.getWidth())* place /8);
            targetY=changedY + Settings.HEIGHT - (( Settings.HEIGHT + this.img.getHeight())* place/8);
