 ...
 * 变奏
 */
public class variation extends AbstractPower {
    // 能力的ID
    public static final String POWER_ID = "variation";
    // 能力的本地化字段
    ...
    public variation(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
...
//        String path48 = "img/newbuff/Example84.png";
        String path128 = "img/newbuff/variationPower84.png";
        String path48 = "img/newbuff/variationPower32.png";
