...
public class EnemyHeavy extends AbstractPower {
    // 能力的ID
    public static final String POWER_ID = "EnemyHeavy";
    // 能力的本地化字段
    ...
    public EnemyHeavy(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
...
//        String path48 = "img/newbuff/Example84.png";
        String path128 = "img/newbuff/ZoePower84.png";
        String path48 = "img/newbuff/ZoePower32.png";
