...
import cards.rare.HaruhikageSongs;
import cards.token.Idea;
import cards.token.OtherHelp;
...
public class AstoundingWisdomPower extends AbstractPower {
    // 这是高潮迭起
    public static final String POWER_ID ="AstoundingWisdomPower";
    // 能力的本地化字段
    ...
    public AstoundingWisdomPower(AbstractCreature owner) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
...
//        String path48 = "img/newbuff/Example84.png";
        String path128 = "img/newbuff/AstoundingWisdomPower84.png";
        String path48 = "img/newbuff/AstoundingWisdomPower32.png";
...
//        addToBot((AbstractGameAction)new RemoveSpecificPowerAction(this.owner, this.owner, POWER_ID));
    ...
    public void onUseCard(AbstractCard card, UseCardAction action) {
        if(card.cardID.equals(Idea.ID) || card.cardID.equals(HaruhikageSongs.ID) || card.cardID.equals(OtherHelp.ID) ){
