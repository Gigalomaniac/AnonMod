...
public class Recollect extends AbstractPower implements OnReceivePowerPower, BetterOnApplyPowerPower {
    // 这是高潮迭起
    public static final String POWER_ID ="Recollect";
    // 能力的本地化字段
    ...
    public Recollect(AbstractCreature owner) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
