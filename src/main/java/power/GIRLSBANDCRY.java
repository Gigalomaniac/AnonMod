...
public class GIRLSBANDCRY extends AbstractPower {
    // 能力的ID
    public static final String POWER_ID = "GIRLSBANDCRY";
    // 能力的本地化字段
    ...
    // 能力的描述
    public GIRLSBANDCRY(AbstractCreature owner) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
    ...
    public int onAttackedToChangeDamage(DamageInfo info, int damageAmount) {
        ...
        while(var4.hasNext()) {
            ...
            if(!m2.isDeadOrEscaped() ){
                if (m2.id.equals("mmk") || m2.id.equals("s486") ) {
                    return 0;
                }
            }
        }
