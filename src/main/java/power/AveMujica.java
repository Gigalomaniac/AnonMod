...
public class AveMujica extends AbstractPower {
    // 能力的ID
    public static final String POWER_ID = "AveMujica";
    // 能力的本地化字段
    ...
    // 能力的描述
    public AveMujica(AbstractCreature owner) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
    ...
    public int onAttackedToChangeDamage(DamageInfo info, int damageAmount) {
        ...
        while(var4.hasNext()) {
            ...
            if(!m2.isDeadOrEscaped() ){
                if (m2.id.equals("Amoris") || m2.id.equals("Timoris") || m2.id.equals("Mortis") || m2.id.equals("Doloris")) {
                    return 0;
                }
            }
        }
