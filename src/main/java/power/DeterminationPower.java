...
public class DeterminationPower extends AbstractPower {
    ...
    public static int ShiningCount = 0;
    // 能力的描述
...
//        this.description = "Anon收到某人影响，现在有" + DESCRIPTIONS[0] + this.amount + DESCRIPTIONS[1] + "个好点子";
        this.description = DESCRIPTIONS[0]+this.amount*ShiningCount+DESCRIPTIONS[1];
    }
...
//        }
    ...
    public void atStartOfTurn() {
        this.addToBot(new GainEnergyAction(this.amount*ShiningCount));
        this.flash();
    }
