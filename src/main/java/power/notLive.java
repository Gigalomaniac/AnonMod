...
public class notLive extends AbstractPower {
    // 这是高潮迭起
    public static final String POWER_ID ="notLive";
    // 能力的本地化字段
    ...
    public notLive(AbstractCreature owner,int Amount, boolean isSourceMonster) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
...
//        String path48 = "img/newbuff/Example84.png";
        String path128 = "img/newbuff/notLivePower84.png";
        String path48 = "img/newbuff/notLivePower32.png";
...
//        super.stackPower(stackAmount);
    ...
    public void atEndOfRound() {
        if (this.justApplied) {
            ...
            if (this.amount == 0) {
                this.addToBot(new RemoveSpecificPowerAction(this.owner, this.owner, "notLive"));
            } else {
                this.addToBot(new ReducePowerAction(this.owner, this.owner, "notLive", 1));
            }
