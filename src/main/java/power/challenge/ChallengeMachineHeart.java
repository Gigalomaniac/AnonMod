...
import power.AshBlessing.BlessingMachineHeart;
...
public class ChallengeMachineHeart extends AbstractPower {
    // 这是高潮迭起
    public static final String POWER_ID ="ChallengeMachineHeart";
    // 能力的本地化字段
    ...
    public ChallengeMachineHeart(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
...
//        String path48 = "img/newbuff/Example84.png";
        String path128 = "img/huijinaiyin/machineHeart150Power84.png";
        String path48 = "img/huijinaiyin/machineHeart150Power32.png";
...
//        addToBot((AbstractGameAction)new RemoveSpecificPowerAction(this.owner, this.owner, POWER_ID));
        ...
        if(InnerFavillaeSide.Stage == 3){
            ...
            while(var4.hasNext()) {
                ...
                if (m2.id.equals("AshAnon") ) {
                    addToBot((AbstractGameAction)new ApplyPowerAction(this.owner, this.owner, (AbstractPower)new ChallengeMachineHeart(m2,999), 999));
                    addToBot((AbstractGameAction)new SuicideAction((AbstractMonster)this.owner));
                }
    ...
    public void onRemove() {
        ...
        while(var4.hasNext()) {
            AbstractMonster m2 = (AbstractMonster)var4.next();
            if (m2.id.equals("AshAnon") ) {
                addToBot((AbstractGameAction)new ApplyPowerAction(m2, m2, (AbstractPower)new BlessingMachineHeart(m2), 1));
                addToBot((AbstractGameAction)new SuicideAction((AbstractMonster)this.owner));
            }
