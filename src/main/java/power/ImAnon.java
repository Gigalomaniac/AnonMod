...
public class ImAnon extends AbstractPower {
    // 这是高潮迭起
    public static final String POWER_ID ="ImAnon";
    // 能力的本地化字段
    ...
    // 能力的描述
    public ImAnon(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
...
//        String path48 = "img/newbuff/Example84.png";
        String path128 = "img/newbuff/AnonLogoPower84.png";
        String path48 = "img/newbuff/AnonLogoPower32.png";
