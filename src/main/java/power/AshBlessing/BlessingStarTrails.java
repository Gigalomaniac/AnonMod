...
public class BlessingStarTrails extends AbstractPower {
    // 这是高潮迭起
    public static final String POWER_ID ="BlessingStarTrails";
    // 能力的本地化字段
    ...
    public BlessingStarTrails(AbstractCreature owner) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
...
//        this.description = "Anon收到某人影响，现在有" + DESCRIPTIONS[0] + this.amount + DESCRIPTIONS[1] + "个好点子";
    ...
    public void onAfterUseCard(AbstractCard card, UseCardAction action) {
        this.flash();
        this.addToBot(new DamageAction(AbstractDungeon.player, new DamageInfo(this.owner, 1, DamageInfo.DamageType.THORNS), AbstractGameAction.AttackEffect.BLUNT_LIGHT));
        this.updateDescription();
    }
