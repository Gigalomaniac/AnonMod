...
public class BlessingSuicideFactor extends AbstractPower {
    // 这是高潮迭起
    public static final String POWER_ID ="BlessingSuicideFactor";
    // 能力的本地化字段
    ...
    public BlessingSuicideFactor(AbstractCreature owner) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
