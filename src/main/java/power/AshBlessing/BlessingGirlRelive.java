...
public class BlessingGirlRelive extends AbstractPower {
    // 这是高潮迭起
    public static final String POWER_ID ="BlessingGirlRelive";
    // 能力的本地化字段
    ...
    public BlessingGirlRelive(AbstractCreature owner) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
