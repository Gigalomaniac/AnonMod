...
public class TrueIllationPower extends AbstractPower {
    // 能力的ID
    public static final String POWER_ID = "TrueIllationPower";
    // 能力的本地化字段
    ...
    public TrueIllationPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        this.amount = Amount;
...
//        super.stackPower(stackAmount);
    ...
    public int onAttackedToChangeDamage(DamageInfo info, int damageAmount) {
        return (int) (damageAmount*(1-this.amount*0.20));
    }
}
