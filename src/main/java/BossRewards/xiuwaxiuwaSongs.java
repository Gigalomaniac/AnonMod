 ...
 * 每一个瞬间的积累
 */
public class xiuwaxiuwaSongs extends FullImgCard {
    ...
    public xiuwaxiuwaSongs() {
        ...
        this.exhaust = true;
        this.setBackgroundTexture("img/pink/1024/bg_skill_pp_512.png","img/pink/1024/bg_skill_pp.png");
        ...
        this.cardsToPreview = (AbstractCard)new xiuwaxiuwaSongsFake();
    }
    ...
    public AbstractCard makeCopy() {
        return (AbstractCard)new xiuwaxiuwaSongs();
    }
