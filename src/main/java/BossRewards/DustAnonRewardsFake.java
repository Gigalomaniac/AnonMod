 ...
 * 每一个瞬间的积累
 */
public class DustAnonRewardsFake extends CustomCard {
    ...
    public static final String IMG_PATH = "img/pink/1024/dust_skill.png";

    //调用父类的构造方法，传参为super(卡牌ID,卡牌名称，能量花费，卡牌描述，卡牌类型，卡牌颜色，卡牌稀有度，卡牌目标)
    public DustAnonRewardsFake() {
    ...
    public AbstractCard makeCopy() {
        return (AbstractCard)new DustAnonRewardsFake();
    }
