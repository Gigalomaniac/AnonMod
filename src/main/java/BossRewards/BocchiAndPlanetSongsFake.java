 ...
 * 每一个瞬间的积累
 */
public class BocchiAndPlanetSongsFake extends CustomCard {
    ...
    public static final String IMG_PATH = "img/card_Anon/BossRewards/bocchi_skill.png";

    //调用父类的构造方法，传参为super(卡牌ID,卡牌名称，能量花费，卡牌描述，卡牌类型，卡牌颜色，卡牌稀有度，卡牌目标)
    public BocchiAndPlanetSongsFake() {
    ...
    public AbstractCard makeCopy() {
        return (AbstractCard)new BocchiAndPlanetSongsFake();
    }
