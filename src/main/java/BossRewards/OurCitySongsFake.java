 ...
 * 每一个瞬间的积累
 */
public class OurCitySongsFake extends CustomCard {
    ...
    public static final String IMG_PATH = "img/card_Anon/BossRewards/OurCity_skill.png";

    public OurCitySongsFake() {
...
//        this.setBannerTexture("img/transparent.png","img/transparent.png");
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard)new OurCitySongsFake();
    }
