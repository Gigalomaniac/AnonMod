...
public class NeverSleepLateAction extends AbstractGameAction {
    private AbstractCard card;
    private AttackEffect effect;

    public NeverSleepLateAction(AbstractCard card, AttackEffect effect) {
        this.card = card;
        this.effect = effect;
    }

    public NeverSleepLateAction(AbstractCard card) {
