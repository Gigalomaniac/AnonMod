...
public class TomoriCrychic extends AbstractPet {
    ...
    public TomoriCrychic(float x, float y) {
        super(NAME, "TomoriCrychic", 0, -8.0F, 10.0F, 70, 70.0F, (String) null, x, y);
        this.setHp(0);
        this.halfDead = true;
        this.img = new Texture(Gdx.files.internal("img/boss/tomoriCrychic.png"));
