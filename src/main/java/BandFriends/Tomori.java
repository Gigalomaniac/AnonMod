...
public class Tomori extends AbstractPet {
    ...
    public Tomori(float x, float y) {
        super(NAME, "Tomori", 10, -8.0F, 10.0F, 70, 70.0F, (String) null, x, y);
        this.setHp(10000000);
        this.halfDead = false;
        this.img = new Texture(Gdx.files.internal("img/boss/tomori_320.png"));
        ...
        if (Settings.language == Settings.GameLanguage.ZHS) {
            ...
            AbstractDungeon.effectList.add(new SpeechBubble(this.hb.cX + this.dialogX, this.hb.cY + this.dialogY + 50, 5F, "Come back and play the guitar... NL do a concert together...", false));
        }
    }
