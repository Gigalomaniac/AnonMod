...
public class Mutsumi extends AbstractPet {
    ...
    public Mutsumi(float x, float y) {
        super(NAME, "Mutsumi", 10, -8.0F, 10.0F, 70, 70.0F, (String) null, x, y);
        this.setHp(10000000);
        this.halfDead = false;
        this.img = new Texture(Gdx.files.internal("img/boss/mutsumi_322.png"));
        this.damage.add(new DamageInfo(this, attackDmg));
        if (Settings.language == Settings.GameLanguage.ZHS) {
            AbstractDungeon.effectList.add(new SpeechBubble(this.hb.cX + this.dialogX , this.hb.cY + this.dialogY + 50, 5F, "这是……小黄瓜 NL 请不要退……", false));
        }else {
            AbstractDungeon.effectList.add(new SpeechBubble(this.hb.cX + this.dialogX , this.hb.cY + this.dialogY + 50, 5F, "This is Gherkin NL Please don't return...", false));
        }
