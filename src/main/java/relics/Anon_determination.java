...
public class Anon_determination extends ClickableRelic implements CustomSavable<SoulHeartSave> {
    public static final String ID = "Anon_determination";
    ...
    public Anon_determination() {
        super("Anon_determination", ImageMaster.loadImage(IMG), AbstractRelic.RelicTier.SPECIAL, AbstractRelic.LandingSound.CLINK);
//        setDescription();
    }
    @Override
