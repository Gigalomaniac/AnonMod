...
//
//public class MashiroScene extends AbstractChangeSceneEffect {
//
////        private Texture img;
...
//            { if(rain){
//                MashiroPatch.ApplyRainShaderToAllCombatBGs.initShader(AbstractDungeon.scene);
//                sb.setShader(MashiroPatch.ApplyRainShaderToAllCombatBGs.getSceneShader(AbstractDungeon.scene));
//                MashiroPatch.ApplyRainShaderToAllCombatBGs.getSceneShader(AbstractDungeon.scene).setUniformf("u_time",MashiroPatch.ApplyRainShaderToAllCombatBGs.getTime());
//            }}
//
//        sb.flush();
