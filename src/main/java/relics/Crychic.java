...
public class Crychic extends ClickableRelic implements CustomSavable<SoulHeartSave> {
    public static final String ID = "Crychic";
    private static final String IMG = "img/relics/crychiclogo.png";
    private static final String IMG_OTL = "img/relics/crychiclogo.png";
    ...
    public Crychic() {
        super("Crychic", ImageMaster.loadImage(IMG), RelicTier.SPECIAL, LandingSound.CLINK);
//        setDescription();
    }
    @Override
...
//        makeAllToHush();
    ...
    private void makeHeartToAnon() {
            if (AbstractDungeon.nextRoom.room instanceof MonsterRoomBoss) {
                AbstractDungeon.nextRoom.room = new MonsterRoomMyBoss(new MonsterGroup(new CrychicSide(-50.0F, 30.0F)));
                AbstractDungeon.lastCombatMetricKey = "Crychic";
//        if (AbstractDungeon.nextRoom.room instanceof MonsterRoomBoss){
