...
public class Rana_relic extends CustomRelic {
    public static final String ID = "Rana_relic";
    private static final String IMG = "img/relics/RanaRecli.png";
    private static final String IMG_OTL = "img/relics/RanaRecli.png";
    ...
    public AbstractRelic makeCopy() {
        return (AbstractRelic)new Rana_relic();
    }
    ...
    public void atBattleStartPreDraw() {
        this.addToBot(new MakeTempCardInHandAction(new bandFriendsCard.Rana(), 1, false));
    }
    public void onEquip() {
    ...
    public void atTurnStart() {
        if(AnonSide.finInfo == 0){
            if(getTurn == 0){
                AbstractCard s = (new bandFriendsCard.Rana()).makeCopy();
                s.upgrade();
                s.costForTurn =0;
                ...
                Rana leechPet = new Rana((float) point.x, (float) point.y);
