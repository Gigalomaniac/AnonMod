...
public class Mutsumi_relic extends CustomRelic {
    public static final String ID = "Mutsumi_relic";
    private static final String IMG = "img/relics/MutsumiRecli.png";
    private static final String IMG_OTL = "img/relics/MutsumiRecli.png";
    ...
    public AbstractRelic makeCopy() {
        return (AbstractRelic)new Mutsumi_relic();
    }
    ...
    public void atBattleStartPreDraw() {
        this.addToBot(new MakeTempCardInHandAction(new bandFriendsCard.Mutsumi(), 1, false));
    }
    public void onEquip() {
