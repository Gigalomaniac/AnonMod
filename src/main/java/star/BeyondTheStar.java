...
import java.util.ArrayList;
 ...
 public class BeyondTheStar extends CustomDungeon {

   public static String ID = "BeyondTheStar";
...
//   public static final String OPTION = TEXT[2];
 public static void NarrationAdd() {

   CustomDungeon.addAct(4, new BeyondTheStar());
    BaseMod.addMonster("StarAnon", StarAnonSide::new);
    BaseMod.addBoss(ID, "StarAnon", "img/star/moto.png", "img/star/moto.png");

 }

 public BeyondTheStar() {
   super(NAME, ID, "img/map/panel.png", false, 0, 0, 1);
...
//     isFinalAct(true);
 ...
 public BeyondTheStar(CustomDungeon cd, AbstractPlayer p, ArrayList<String> emptyList) { super(cd, p, emptyList); }

 public BeyondTheStar(CustomDungeon cd, AbstractPlayer p, SaveFile saveFile) { super(cd, p, saveFile); }
...
//     AbstractDungeon.nextRoomTransitionStart();
 ...
 public String getOptionText() { return "追随星遗物的引导（更困难的挑战）"; }
 ...
 public AbstractScene DungeonScene() { return new TheEndingScene(); }
  ...
  protected void makeMap() {
    ...
    shopNode.room = new ShopRoom();
      ...
      enemyNode.room = new starEventRoom(enemyNode);
