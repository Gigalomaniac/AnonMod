...
public class starEventRoom extends AbstractRoom {

    MapRoomNode currNode;
    MapRoomNode node;
    public starEventRoom(MapRoomNode enemyNode) {
    ...
    public void onPlayerEntry() {
        ...
        this.node.setRoom(new EventRoom() {
            public void onPlayerEntry() {
                AbstractDungeon.overlayMenu.proceedButton.hide();
                if(!AbstractDungeon.player.hasRelic(StarAnonGuitar.ID))
                this.event = new StarAnonEvent();
                else
                    this.event = new StarAnonEventAgain();
