...
public class SakikoShop extends AbstractImageEvent {
   public static final String ID = "SakikoShop";
   ...
   private static final String imgUrl = "img/event/bg00886.png";
   ...
   private static UIStrings soraMessage = CardCrawlGame.languagePack.getUIString("ShopMessage");
   ...
   public SakikoShop() {
     super(title, DESCRIPTIONS[0], imgUrl);
       SakikoImg.put("Pre",new Texture("img/live2d/SakikoShop3.png"));
     ...
     int index = 0;
       AbstractDungeon.getCurrRoom().setMapImg(ImageMaster.loadImage("img/UI/FamilyMart.png"), ImageMaster.loadImage("img/UI/FamilyMart.png"));
     ...
     index++;
      ...
      addShopItem(index, SakikoShopItem.ShopItem.LiveBoost);
       index++;
       addShopItem(index, SakikoShopItem.ShopItem.ExcessiveFantasy);
       index++;
   ...
   protected void buttonEffect(int i) {
     switch (this.currentScreen) {
       case START:
         ...
         this.effect2 = new SakikoShopBG(ImageMaster.loadImage("img/live2d/SakikoShop3.png"));
