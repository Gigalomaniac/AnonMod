 ...
 public class AnotherStoryExcessiveFantasyEndingSoyo extends AbstractGameEffect {
   public static final String ID = "AnotherStoryExcessiveFantasyEndingSoyo";
     ...
     public AnotherStoryExcessiveFantasyEndingSoyo(int start, int end) {

         Texture SCENE1_TEXTURE =  new Texture("img/boss/AnonHouse.png");
         this.SCENE1 = new TextureRegion(SCENE1_TEXTURE);
         Texture SCENE2_TEXTURE =  new Texture("img/boss/bg01021.png");
