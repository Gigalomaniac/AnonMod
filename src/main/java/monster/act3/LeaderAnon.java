...
public class LeaderAnon extends AbstractSpriterMonster {
    public static final String ID = "LeaderAnon";
    ...
    public LeaderAnon(float x, float y) {
        super(NAME, ID, 1147483647, 0.0F, 0.0F, 300.0F, 500.0F, (String)null, x, y);
...
//                }
            ...
            case 0:
                ...
                while(var4.hasNext()) {
                    ...
                    if(!m2.isDeadOrEscaped() ){
                        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(m2, this, new StrengthPower(AbstractDungeon.player, 1), 1));
                    }
                }
...
//        }
    ...
    static {
        monsterStrings = CardCrawlGame.languagePack.getMonsterStrings("LeaderAnon");
