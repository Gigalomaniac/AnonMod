 ...
 * 每一个瞬间的积累
 */
public class WorldLegacy extends CustomCard {
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("WorldLegacy");
    public static final String NAME = cardStrings.NAME;
    public static final String DESCRIPTION = cardStrings.DESCRIPTION;
    private static int COST = 0;
    public static final String ID = "WorldLegacy";
    public static final String IMG_PATH = "img/card_Anon/White/Anon star_skill.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction)new ApplyPowerAction((AbstractCreature)p, (AbstractCreature)p, (AbstractPower)new songs((AbstractCreature)p, "星遗物"), this.magicNumber));
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard)new WorldLegacy();
    }
