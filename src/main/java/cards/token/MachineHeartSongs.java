 ...
 * 每一个瞬间的积累
 */
public class MachineHeartSongs extends CustomCard {
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("MachineHeartSongs");
    public static final String NAME = cardStrings.NAME;
    public static final String DESCRIPTION = cardStrings.DESCRIPTION;
    private static int COST = 1;
    public static final String ID = "MachineHeartSongs";
    public static final String IMG_PATH = "img/card_Anon/machineheart_skill.png";

    //调用父类的构造方法，传参为super(卡牌ID,卡牌名称，能量花费，卡牌描述，卡牌类型，卡牌颜色，卡牌稀有度，卡牌目标)
    public MachineHeartSongs() {
...
//        this.baseMagicNumber = 2;
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard)new MachineHeartSongs();
    }
