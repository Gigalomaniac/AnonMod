 ...
 * 迷星叫
 */
public class MayoiutaSongs extends CustomCard {
//    private static final CardStrings cardStrings = "GiveNote";
    public static final String NAME = "迷星叫";
    public static final String DESCRIPTION = "演奏：迷星叫";
    private static final int COST = 0;
    public static final String ID = "MayoiutaSongs";
    public static final String IMG_PATH = "img/cards_Seles/SavePower.png";

    //调用父类的构造方法，传参为super(卡牌ID,卡牌名称，能量花费，卡牌描述，卡牌类型，卡牌颜色，卡牌稀有度，卡牌目标)
    public MayoiutaSongs() {
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard)new MayoiutaSongs();
    }
