 ...
 * 每一个瞬间的积累
 */
public class HekitenbansouSongs extends CustomCard {
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("HekitenbansouSongs");
    public static final String NAME = cardStrings.NAME;
    public static final String DESCRIPTION = cardStrings.DESCRIPTION;
    private static int COST = 0;
    public static final String ID = "HekitenbansouSongs";
    public static final String IMG_PATH = "img/card_Anon/bitian_skill.png";

    //调用父类的构造方法，传参为super(卡牌ID,卡牌名称，能量花费，卡牌描述，卡牌类型，卡牌颜色，卡牌稀有度，卡牌目标)
    public HekitenbansouSongs() {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction)new ApplyPowerAction((AbstractCreature)p, (AbstractCreature)p, (AbstractPower)new songs((AbstractCreature)p, "碧天伴走"), this.magicNumber));
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard)new HekitenbansouSongs();
    }
