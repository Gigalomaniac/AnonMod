 ...
 * 名無声
 */
public class NamonakiSongs extends CustomCard {
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("NamonakiSongs");
    public static final String NAME = cardStrings.NAME;
    public static final String DESCRIPTION = cardStrings.DESCRIPTION;
//    public static final String DESCRIPTION = "演奏：名無声 NL 演奏开始时清空负面效果获得20点 格挡";
    private static final int COST = 0;
    public static final String ID = "NamonakiSongs";
    public static final String IMG_PATH = "img/card_Anon/mingwusheng_skill.png";

    //调用父类的构造方法，传参为super(卡牌ID,卡牌名称，能量花费，卡牌描述，卡牌类型，卡牌颜色，卡牌稀有度，卡牌目标)
    public NamonakiSongs() {
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard)new NamonakiSongs();
    }
