...
import bossRoom.effect.PaperEffect;
...
public class NewDrawCardEffect extends AbstractChangeSceneEffect {
  ...
  public NewDrawCardEffect(int code) {
  ...
  public NewDrawCardEffect(Texture img) {
        this.color = Color.WHITE.cpy();
        this.renderBehind = true;
        this.img = img;
        this.img2 = ImageMaster.loadImage("img/vfx/Mask.png");
