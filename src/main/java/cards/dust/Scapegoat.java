 ...
 * 备注: 基础打击牌（初始牌）
 */
public class Scapegoat extends SpecialAnonCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster a) {
        addToBot((AbstractGameAction)new ApplyPowerAction(a, AbstractDungeon.player, new DustAnonSign(a), 1));
    }
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard)new Scapegoat();
    }
