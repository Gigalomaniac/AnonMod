 ...
 * 备注: 基础打击牌（初始牌）
 */
public class Mixer extends SpecialAnonCard {
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("Mixer");
    public static final String NAME = cardStrings.NAME;
    public static final String DESCRIPTION = cardStrings.DESCRIPTION;
    public static final String IMG_PATH = "img/card_Anon/dust/9_skill.jpg";
    ...
    public void use(AbstractPlayer p, AbstractMonster a) {
        ...
        addToBot((AbstractGameAction)new ApplyPowerAction(p, AbstractDungeon.player, new StrengthPower(p,1), 1));
    }
